...
public class MainActivity<critical> extends AppCompatActivity {
...
*/
    ...
    private void sendMessage() {
                        ...
                        final String inputmessage = this.inputMessage.getText().toString();
        final int[] critical = {0};
                        if (!this.initialRequest) {
                            Message inputMessage = new Message();
                            inputMessage.setMessage("Y̲O̲U̲\n\n"+inputmessage);
                            ...
                            Thread thread = new Thread(new Runnable() {
                                ...
                                public void run() {
                                    String webpage = "https://nancy1.herokuapp.com/api/v1/resources/books?id=" + inputmessage;
                                    ...
                                    if(result.startsWith("\"None")){
                                        result="\"We can not understand you!\"";
                                    }

                                    Message inputtMessage = new Message();
inputtMessage.setMessage("C̲h̲a̲t̲B̲o̲t̲                                                                                              \n\n"+result);
                                    inputtMessage.setId("2");
                                    messageArrayList.add(inputtMessage);
                                    critical[0] =1;
                            ...
                            final Thread thread = new Thread(new Runnable() {
                                ...
                                public void run() {
                                    String webpage = "https://nancy1.herokuapp.com/api/v1/resources/books?id=" + "hi1";
                                    while(true) {
                                        try {
                                            URL url = null;
                            ...
                            String fm="Hello. I 'm a chatbot here to assist you with your questions about restaurant  hours, locations and food recommendations.";
                            Message firstMessage = new Message();
                            firstMessage.setMessage("C̲h̲a̲t̲B̲o̲t̲                                                                                              \n\n"+fm);

                            inputMessage.setId("2");
                            messageArrayList.add(firstMessage);
                        ...
                        if(critical[0]==2){
                            Message inputtMessage = new Message();
                            String result="\"Bot can not connect to Server\"";
inputtMessage.setMessage("C̲h̲a̲t̲B̲o̲t̲                                                                                              \n\n"+result);
                            inputtMessage.setId("2");
                            messageArrayList.add(inputtMessage);
                        }
